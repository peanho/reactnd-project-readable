## Readable Frontend
This app requires the server in the app-server directory running on port 3001. In order to execute the app, download or clone it to a directory in your local machine, then run:
```
npm install
npm run
```
